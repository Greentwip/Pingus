...
#ifdef LOGMICH_DLL
#define LOGMICH_DECLSPEC __declspec( dllexport )  
#else
#define LOGMICH_DECLSPEC __declspec( dllimport )
#endif

namespace logmich {

extern LOGMICH_DECLSPEC Logger g_logger; // horrible extern declaration here
