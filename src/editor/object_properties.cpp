...
ObjectProperties::ObjectProperties(EditorScreen* editor_, const Rect& rect_) :
  ...
  y_pos()
{
  type_label = create<EditorLabel>(Rect(Vector2i(4, 4), Size(120, 20)), _("Object:"));
  mesg_label = create<EditorLabel>(Rect(Vector2i(10, 0), Size(180, 20)), _("Nothing selected"));

  Rect label_rect(10,0, 80, 20);
  Rect box_rect(80,0, 190, 20);

  // Groundpiece Type
  gptype_label = create<EditorLabel>(label_rect, "GPType:");
  ...
  entrance_direction_label = create<EditorLabel>(label_rect, _("Direction:"));
  ...
  release_rate_label = create<EditorLabel>(label_rect, _("ReleaseRate:"));
  ...
  // Background Stretch
  stretch_label = create<EditorLabel>(label_rect, "Stretch:");
  ...
  keep_aspect_label = create<EditorLabel>(label_rect, "Aspect:");
  ...
  para_x_label = create<EditorLabel>(label_rect, _("Para-X:"));
  para_y_label = create<EditorLabel>(label_rect, _("Para-Y:"));
  ...
  scroll_x_label = create<EditorLabel>(label_rect, _("Scroll-X:"));
  scroll_y_label = create<EditorLabel>(label_rect, _("Scroll-Y:"));
  ...
  owner_label = create<EditorLabel>(label_rect, _("Owner Id:"));
  ...
  pos_x_label = create<EditorLabel>(label_rect, _("X-Pos:"));
  ...
  pos_y_label = create<EditorLabel>(label_rect, _("Y-Pos:"));
  ...
  pos_z_label = create<EditorLabel>(label_rect, _("Z-Pos:"));
  ...
  color_label = create<EditorLabel>(label_rect, _("Color:"));
  ...
  // ___________________________________________________________________
  //
  small_stars_label    = create<EditorLabel>(label_rect, _("Small Stars:"));
  small_stars_inputbox = create<Inputbox>(box_rect);

  middle_stars_label    = create<EditorLabel>(label_rect, _("Middle Stars:"));
  middle_stars_inputbox = create<Inputbox>(box_rect);

  large_stars_label    = create<EditorLabel>(label_rect, _("Large Stars:"));
  ...
  // ___________________________________________________________________
  //
  repeat_label = create<EditorLabel>(label_rect, _("Repeat:"));
  ...
  // ___________________________________________________________________
  //
  id_label    = create<EditorLabel>(label_rect, _("Id:"));
  ...
  target_id_label    = create<EditorLabel>(label_rect, _("Target Id:"));
  ...
  // ___________________________________________________________________
  //
  height_label    = create<EditorLabel>(label_rect, _("Height:"));
