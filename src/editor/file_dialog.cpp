  ...
  filename_inputbox()
{
  ...
  filename_label = create<EditorLabel>(Rect(6, 4+30, 4 + 60, 26+30), _("Filename:"));
  pathname_label = create<EditorLabel>(Rect(6, 4+60, 4 + 60, 26+60), _("Pathname:"));
