...
private:
  ...
  EditorLabel*    id_label;
  Inputbox* id_inputbox;

  EditorLabel*    target_id_label;
  Inputbox* target_id_inputbox;

  EditorLabel*    height_label;
