...
LevelProperties::LevelProperties(EditorScreen* editor_, const Rect& rect_) :
  ...
  music()
{
  create<EditorLabel>(Rect(Vector2i( 10,  10), Size( 80, 20)), _("Author:"));
  author = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10,  32), Size( 80, 20)), _("Levelname:"));
  levelname = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10,  54), Size( 80, 20)), _("Description:"));
  description = create<Inputbox>();

  int y = 116;
  create<EditorLabel>(Rect(Vector2i( 10,  y), Size( 80, 20)), _("Pingus Count:"));
  number_of_pingus = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10,  y+22), Size( 80, 20)), _("Pingus to Save:"));
  number_to_save = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10,  y+44), Size( 80, 20)), _("Time:"));
  time = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10,  y+66), Size( 80, 20)), _("Width:"));
  width = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10,  y+88), Size( 80, 20)), _("Height:"));
  height = create<Inputbox>();

  create<EditorLabel>(Rect(Vector2i( 10, y+110), Size( 80, 20)), _("Music:"));
